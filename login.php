...
<a href="<?php echo $url_home; ?>">Dive Into The World Of Solutions </a></div>
<?php
        }
        else
        {
...
$nb_new_pm = mysql_fetch_array(mysql_query('select count(*) as nb_new_pm from pm where ((user1="'.$user_id.'" and user1read="no") or (user2="'.$user_id.'" and user2read="no")) and id2="1"'));
...
<div class="box">
    ...
    <div class="box_right">
        <?php $user_name = isset($_SESSION['username']); ?>
        <a href="list_pm.php">Your messages(<?php echo $nb_new_pm; ?>)</a> - <a 
        href="profile.php?id=<?php echo $_SESSION['userid']; ?>"><?php echo htmlentities($user_name, ENT_QUOTES, 'UTF-8'); ?></a> (<a 
